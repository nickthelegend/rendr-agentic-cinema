				...
				vite: {
					build: {
						...
						rollupOptions: {
							...
							// kokoro-js resolves its voice files relative to its own
							// __dirname; bundling it would point that at the build
							// output, where there are no voices. onnxruntime-node is
							// a native addon and cannot be bundled at all.
							external: [
								"ffmpeg-static",
								"uiohook-napi",
								"kokoro-js",
